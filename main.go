...
func main() {
	...
	go BuscarCepViaCEP(cepExample, cVC)
	go BuscarCepBrasilAPI(cepExample, cBA)
...
func BuscarCepViaCEP(cep string, ch chan CEP) {
...
func BuscarCepBrasilAPI(cep string, ch chan CEP) {
